...
// import MobileLogoWhite from "@/assets/images/logo/afz-logo.png";
    ...
    >
      ...
      {(!collapsed || menuHover) && (
        <div
          ...
          className={`h-4 w-4 flex-none border-[1.5px] border-slate-900 dark:border-slate-700 rounded-full transition-all duration-150
          ${
            collapsed
              ? ""
